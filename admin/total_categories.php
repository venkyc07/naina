                            ...
                            <div class="">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary" style="text-transform: capitalize;float:left">Total Categories</h6>
                                        <a class="open-homeEvents btn btn-primary" style="float:right" href="add_category.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Category</a>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="open-homeEvents btn btn-danger"  href="add_category.php?id=<?php echo $row['category_id']; ?>"> <i class="fa fa-edit"></i>&nbsp;&nbsp;Edit</a>

                                                                <button class="delete btn btn-danger" data-id="<?php echo $row["category_id"]; ?>" data-tableidprimary = "category_id" data-table_name = "category"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete</button>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                            }
                        ...
                        success: function(response){
                            if(response.status == 1){
                                ...
                                if(table_name === 'category') {
                                    window.location.href = "total_categories.php";
                                } 
