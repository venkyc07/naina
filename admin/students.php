                            ...
                            <div class="">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary" style="text-transform: capitalize;float:left">Total Students</h6>
                                        <!-- <a class="open-homeEvents btn btn-primary" style="float:right" href="add_doctor.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Doctor</a> -->
                                    </div>
                                    <div class="card-body" style="background: white;">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="stddataTable" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th>SNo</th>
                                                        <th>First Name</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php if(!empty($row['address'])) { echo $row['address'].', '.$row['city'].' '.$row['pincode']; } else { echo ""; }?></td>
                                                        </tr>                                                       
                        ...
                        success: function(response){
                            if(response.status == 1){
                                ...
                                if(table_name === 'doctors') {
                                    window.location.href = "total_doctors.php";
                                } 
