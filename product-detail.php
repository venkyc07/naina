        ...
        <div class="row px-xl-5">
                    ...
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100"
                                src="img/Semi tusser kalamkari print Ssrees 3800/Semi tusser kalamkari print Ssrees1.jpeg"
                                alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100"
                                src="img/Semi tusser kalamkari print Ssrees 3800/Semi tusser kalamkari print Ssrees2.jpeg"
                                alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100"
                                src="img/Semi tusser kalamkari print Ssrees 3800/Semi tusser kalamkari print Ssrees3.jpeg"
                                alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100"
                                src="img/Semi tusser kalamkari print Ssrees 3800/Semi tusser kalamkari print Ssrees4.jpeg"
                                alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <h3>Semi tusser kalamkari print Saree</h3>
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1">(44 Reviews)</small>
                    </div>
                    <h3 class="font-weight-semi-bold mb-4">3800/-</h3>
                    ...
                    <!-- <form button>
                        <script src="https://checkout.razorpay.com/v1/payment-button.js"
                            data-payment_button_id="pl_ImHkPIvyMItCh5" async> </script>
                    </button></form> -->
